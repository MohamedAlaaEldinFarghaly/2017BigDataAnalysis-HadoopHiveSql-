...
INSERT OVERWRITE LOCAL DIRECTORY 'test' ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE 
SELECT Issue_Date --substr(Issue_Date,1,2) AS Issue_Date_month,Issue_Date
FROM Project;
